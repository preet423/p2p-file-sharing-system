  ...
  return (
    <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
      ...
      <div className="flex items-center">
        <div className="flex-1 bg-white p-3 rounded-l-md border border-r-0 border-gray-300 font-mono text-sm break-all">
          {fileId}
        </div>
        <button
      ...
      <p className="mt-3 text-xs text-gray-500">
        This code can be used to download the file multiple times.
      </p>
    </div>
  );
}
